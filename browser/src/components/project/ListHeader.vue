                ...
                <ul>
                    <li>
                        <router-link to="/project/list">
                            <span :class="{'system-name':true, current:$route.query.projectField === undefined}">全部项目</span>
                        </router-link>
                    </li>
                    <li v-for="field in fields" :key="field.value">
                        <router-link :to="`${$route.path}?projectField=${field.value}`">
                        <span :class="{'system-name':true, current:field.value.toString() === $route.query.projectField}">
                            {{field.label}}
                        </span>
                        </router-link>
                    </li>
