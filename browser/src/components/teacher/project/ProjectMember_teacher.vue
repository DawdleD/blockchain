        ...
        methods: {
            ...
            async getProject(page) {
                try {
                    ...
                    let response = await this.$axios.get(`/api/project/query/getprojectauthed?`,
                        {params:dict});
                    let responseCount=await this.$axios.post(`/api/project//query/getprojectcountauthed`,dict);
